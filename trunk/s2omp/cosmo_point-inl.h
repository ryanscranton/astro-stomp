...
public:
  inline cosmo_point(double x, double y, double z, double weight,
                     double redshift);
...
inline cosmo_point* cosmo_point::from_radec_rad(
    double ra_rad, double dec_rad, double weight, double redshift) {
...
inline double cosmo_point::dot(const cosmo_point& p) {
  return cosmology::comoving_distance(redshift_) *
      (unit_sphere_x() * p.unit_sphere_x() + unit_sphere_y() * p.unit_sphere_y()
       + unit_sphere_z() * p.unit_sphere_z());
}

inline double cosmo_point::dot(const cosmo_point* p) {
  return cosmology::comoving_distance(redshift_) *
      (unit_sphere_x() * p->unit_sphere_x() +
       unit_sphere_y() * p->unit_sphere_y() +
       unit_sphere_z() * p->unit_sphere_z());
}
